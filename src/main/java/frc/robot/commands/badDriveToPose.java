...
public class badDriveToPose extends Command {
  ...
  public badDriveToPose(Drive drive, Supplier<Pose2d> target) {
    this.drive = drive;
  ...
  public badDriveToPose(Drive drive, Supplier<Pose2d> target, Supplier<Pose2d> robot) {
    this(drive, target);
    this.robot = robot;
  }

  public badDriveToPose(
      Drive drive,
