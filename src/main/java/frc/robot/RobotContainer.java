...
public class RobotContainer {
  ...
  //public final Camera Sight1 = new Camera();
 ...
 */
  ...
  private void configureBindings() {
    ...
    m_testController.povRight().whileTrue(Commands.run(() -> AlgaeYoinker.holdAlgae(), AlgaeYoinker));
    ...
    m_testController.leftTrigger().whileTrue(Commands.run(() -> CageAscender.testDown(), CageAscender));
    m_testController.rightTrigger().whileTrue(Commands.run(() -> CageAscender.testUp(), CageAscender));
 ...
 */
    //m_driverController.button(Constants.controller.ShootButton).onTrue(new Dunk(AlgaeYoinker, SeaElevator, swerve));
    //m_driverController.button(Constants.controller.EjectButton).onTrue(new Eject(AlgaeYoinker));
    //m_driverController.button(Constants.controller.GoToL1).onTrue(new GoToScore(theArm, SeaElevator, Targets.L1));
    //m_driverController.button(Constants.controller.GoToL2).onTrue(new GoToScore(theArm, SeaElevator, Targets.L2));
    //m_driverController.button(Constants.controller.GoToL3).onTrue(new GoToScore(theArm, SeaElevator, Targets.L3));
    //m_driverController.button(Constants.controller.GoToL4).onTrue(new GoToScore(theArm, SeaElevator, Targets.L4));
    //m_driverController.button(Constants.controller.ThrowAlgaeTheButton).onTrue(new ThrowAlgae(theArm, AlgaeYoinker, SeaElevator));
  }
