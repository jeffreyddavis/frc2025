...
public class Climber extends SubsystemBase {
  ...
  public Climber() {
    LeftMotor = new SparkMax(Constants.Climber.leftMotor, com.revrobotics.spark.SparkLowLevel.MotorType.kBrushless);
    
    RightMotor = new SparkMax(Constants.Climber.rightMotor, com.revrobotics.spark.SparkLowLevel.MotorType.kBrushless);
  ...
  public void periodic() {
    ...
    if (this.movingToTarget) {
      if (!isAtLocation()) {
          LeftMotor.set( (ClimberDegrees() < targetAngle) ? Constants.Climber.Speed : -Constants.Climber.Speed);
      } else {
